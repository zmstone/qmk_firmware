...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_5x6(
        ...
        KC_GRV  , KC_Z , KC_X   , KC_C    , KC_V   , KC_B    ,      KC_N    , KC_M    , KC_COMM , KC_DOT  , KC_SLSH , KC_BSLS  ,
            TT(_RAISE) , KC_LGUI, KC_LALT , KC_SPC , KC_LSFT ,      KC_RCTL , KC_BSPC , KC_LBRC , KC_RBRC , TT(_LOWER)
    ),
    [_LOWER] = LAYOUT_5x6(
        KC_0    , KC_F1  ,KC_F2  ,KC_F3  ,KC_F4  ,KC_F5  ,        KC_F6   , KC_F7    , KC_F8   , KC_F9   , KC_F10   , KC_F11 ,
        ...
        KC_TILD , KC_PERC,KC_CIRC,KC_LT,  KC_GT,  KC_UNDS,        KC_6    , KC_7     , KC_8    , KC_9    , KC_0     , _______ ,
                  _______,KC_DOT ,KC_DOT ,KC_TAB, KC_ESC,         KC_DOT  , KC_MINS  , KC_0    , KC_0    , _______
    ),
    [_RAISE] = LAYOUT_5x6(
        _______,_______,_______,_______,_______,_______,     _______,_______,_______,_______,_______,_______,
        _______,_______,_______,KC_MS_U,_______,_______,     _______,_______,_______,_______,_______,_______,
        _______,_______,KC_MS_L,KC_MS_D,KC_MS_R,_______,     KC_WH_L,KC_WH_D,KC_WH_U,KC_WH_R,_______,KC_MPLY,
        _______,_______,_______,_______,_______,_______,     KC_VOLD,KC_VOLU,KC_MPRV,KC_MNXT,_______,_______,
                _______,_______,_______,_______,_______,     KC_BTN1,KC_BTN2,KC_BTN3,KC_MUTE,_______
    )
};
